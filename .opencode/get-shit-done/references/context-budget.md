...
The keys live in `.claude/settings.json` (project) or `/Users/felipepersonmalta/Documents/Projetos/openipaas/openipaas/.opencode/settings.json` (global) — **not** in `.planning/config.json`:
