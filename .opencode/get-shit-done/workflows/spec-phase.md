...
```bash
INIT=$(node "/Users/felipepersonmalta/Documents/Projetos/openipaas/openipaas/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/felipepersonmalta/Documents/Projetos/openipaas/openipaas/.opencode/get-shit-done/templates/spec.md.
