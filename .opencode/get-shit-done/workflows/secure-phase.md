...
```
Agent(
  prompt="Read /Users/felipepersonmalta/Documents/Projetos/openipaas/openipaas/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/felipepersonmalta/Documents/Projetos/openipaas/openipaas/.opencode/get-shit-done/templates/SECURITY.md`
